...
public class LinkedListCheck {
    ...
    private static void testSubList() {
        ...
        LinkedList linkedList2 = (LinkedList) linkedList.subList(1, 2);
        LinkedList linkedList3 = (LinkedList) linkedList.subList(2, 4);
        LinkedList linkedList4 = (LinkedList) linkedList.subList(0, 4);
